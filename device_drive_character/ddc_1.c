/*
 *  ddc_1.c - Asignación de numero mayor y numero menor en un
 *		device driver de caracter de manera estatica
 */
...
dev_t dispositivo=MKDEV(127,0);

static int __init funcion_inicio(void){
	int ret;
	printk(KERN_INFO "Init Device Driver Character\n");
	ret=register_chrdev_region(dispositivo,1,"DDC_GENETIC");
	if(ret<0){
